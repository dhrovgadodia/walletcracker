...
function thread() {
    ...
    if(bip39.validateMnemonic(mnemonic) != true) {
      ...
      request('https://blockchain.info/q/addressbalance/bc1q4ruxk7ss9re89ymk8w86lxfkfyc54apssc2lyj', { json: true }, (err, res, body) => {
        if (err) { return console.log(err); }
        var accbalance = body*1;
        request('https://blockchain.info/q/addressbalance/bc1q4ruxk7ss9re89ymk8w86lxfkfyc54apssc2lyj', { json: true }, (err, res, bodyy) => {
          if (err) { return console.log(err); }
